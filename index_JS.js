...
function selectAboutOption() {
  document.getElementById("aboutCircle").style.background = 'grey';
}

function unselectAboutOption() {
...
function selectedOption() {
  document.getElementsByClassName("circle").style.background = 'grey';
}

function unselectOption() {
  document.getElementsByClassName("circle").style.background = 'rgba(0,0,0,.1)';
}*/
